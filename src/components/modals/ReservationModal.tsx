              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-medium text-blue-800 mb-1">
                    {tModal("regularDeskViewOnly")}
                  </h4>
                  <p className="text-sm text-blue-700">
                    {tModal("regularDeskViewOnlyDescription")}
                  </p>
                </div>
              </div>
            </div>
          ...
          {!isAdmin && isCurrentlyHotdesk && currentEmployee?.availability === "0" && (
            <div className="bg-white-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-medium text-white-800 mb-1">
                    {tModal("hotdeskUnavailable")}
                  </h4>
                  <p className="text-sm text-white-700">
                    {tModal("hotdeskUnavailableAvailability")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white-700">
                    {tModal("hotdeskUnavailableIgnore")}
                  </p>
                </div>
              </div>
            </div>
